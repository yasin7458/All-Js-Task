...
if (n1 > n2) {
    ...
    if (n1 > n3) {
        ...
        if (n1 > n4) {
            document.querySelector('h1').innerHTML = "N1, N2 And N3 Are Equal And Greater"  // ✅ Fixed: was "N1,N2 And N4"
        }
        else if (n1 == n4) {
        ...
        if (n3 > n4) {
            ...
            document.querySelector('h1').innerHTML = "N3 And N4 Are Equal And Greater"  // ✅ Fixed: "GReater" → "Greater"
        }
        else {
            document.querySelector('h1').innerHTML = "N4 Is Greater"
        }
